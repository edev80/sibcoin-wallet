...
public final class BitcoinIntegration
{
	...
	{
		Toast.makeText(context, "No sibcoin application found.\nPlease install sibcoin Wallet.", Toast.LENGTH_LONG).show();

		final Intent marketIntent = new Intent(Intent.ACTION_VIEW, Uri.parse("market://details?id=rusapps.sibcoin.wallet"));
		final Intent binaryIntent = new Intent(Intent.ACTION_VIEW, Uri.parse("https://github.com/edev80/sibcoin-wallet/releases"));
